...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Godson' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Godson' : process.env.OWNER_NAME,
